...
__CAMERA_FILE_PARAMS = '/usr/local/share/openMVG/sensor_width_camera_database.txt'

__PGS_TO_OPENMVG_ROT_MAT = np.array([[-1, 0, 0], [0, 1, 0], [0, 0, -1]])


def load_cam_db(db_path: Path) -> dict:
    # Load the cam db
    d = {}
...
class View(SfMSceneElement):
    ...
    def intrinsic_id(self) -> int:
        return self._intrinsic_id

    @intrinsic_id.setter
    def intrinsic_id(self, i: int):
        self._intrinsic_id = i
